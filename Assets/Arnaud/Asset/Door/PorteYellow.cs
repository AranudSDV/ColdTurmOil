...
public class PorteYellow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Inventory.instance.HasObject("Yellow Card") == true && rayHit3 == true)
            {
                plateformIsMoving = true;
                plateform2IsMoving = true;
                
                Debug.Log("scitp porte yellow marche");
            }
    }
    // 
}
